...
class CodeIgniter
{
     ...
     *  php-cli: Invoked by CLI via `php Cosplay/index.php`
     *
    ...
    public function run(?RouteCollectionInterface $routes = null, bool $returnResponse = false)
    {
        if ($this->context === null) {
            throw new LogicException(
                ...
                . 'you need to merge `Cosplay/index.php` and `spark` file from `vendor/codeigniter4/framework`.'
            );
        }
     ...
     *  2. PHP CLI: accessed by CLI via php Cosplay/index.php, arguments become URI segments,
