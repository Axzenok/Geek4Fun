...
class SiteURI extends URI
{
     ...
     * The baseURL "http://localhost:8888/ci431/Cosplay/" → '/ci431/Cosplay/'
     */
     ...
     *
     * If the URI is "http://localhost:8888/ci431/Cosplay/index.php/test?a=b",
     * and the baseURL is "http://localhost:8888/ci431/Cosplay/", then:
     *   $baseSegments = [
     *       0 => 'ci431',
     *       1 => 'Cosplay',
     *       2 => 'index.php',
